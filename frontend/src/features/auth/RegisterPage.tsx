    ...
    <div className="login-container">
      ...
      <div className="login-card">
        <div className="login-header">
          ...
          <p className="login-subtitle">Bergabung bersama petani dan pembeli di Taniku</p>
        </div>
        ...
        <form onSubmit={handleRegister}>
          <div className="login-field">
            ...
            <div className="login-input-wrapper">
              ...
              <input type="text" placeholder="CV. Nama Usaha / Nama Kamu"
        ...
        <div className="login-security">🛡 Data kamu aman dan terenkripsi</div>
      </div>
