-- ============================================================================
-- URGENT FIX: Tambah kolom rating ke tabel Product
-- ============================================================================
-- Jalankan SQL ini di phpMyAdmin untuk database 'garuda'
-- ============================================================================

-- Tambah kolom rating ke tabel Product
ALTER TABLE `Product` ADD COLUMN `rating` FLOAT NOT NULL DEFAULT 4.5;

-- Update rating untuk semua produk yang sudah ada
...
-- ============================================================================
-- SELESAI! Sekarang restart backend server
-- ============================================================================
